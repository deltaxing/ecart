...
if(request.getParameter("WIDout_trade_no")!=null){
	...
	//因为在jfinal的 主doFilter里 为所有request.setCharacterEncoding了,而此方法 只对 请求体，即post有效；get的参数在uri里，所以 默认进行了ISO-8859-1编码
	//本程序中，全部采用post，故此处，直接 getParameter 就可正常获取 中文
...
<div id="main">
		...
		<button class="new-btn-login" style="text-align:center;" onclick="post()" >post</button>
		<button class="new-btn-login" style="text-align:center;" onclick="get()" >get</button>
        <div id="foot">
			<ul class="foot-ul">
				<li>
...
function post(){
	postAjax('/ecart/Getutf', { WIDout_trade_no: 1111, WIDsubject: '手机网站支付测试商品',WIDtotal_amount: 0.01, WIDbody: '购买测试商品0.01元' }, function(data){ console.log(data); });	
}
...
function get(){
	// example request
	getAjax('/ecart/Getutf?WIDsubject=星星', function(data){ console.log(data); });	
}
